...
class dielectric : public material {
    public:
        ...
        bool scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered) const override {
            attenuation = color(1.0, 1.0, 1.0); // Glass doesn't absorb any color
            double ri = rec.front_face ? (1.0/refraction_index) : refraction_index; // The 1.0 is the air's refraction indicie
